  ...
  return (
    <div className='pb-20 pt-36 ' >
      <div>
        ...
        <Spotlight className='top-10 left-full h-[70vh] w-[50vw]' fill='purple' />
      ...
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[60vw] flex flex-col items-center justify-center '>
          ...
          <TextGenerateEffect
            className='text-center text-[25px] md:text-3xl lg:text-3xl'
            words='Building Robust Solutions for Complex Problems with Strong Algorithmic Expertise'
          />
